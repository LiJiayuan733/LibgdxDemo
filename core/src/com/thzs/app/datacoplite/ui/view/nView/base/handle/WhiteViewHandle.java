...
public class WhiteViewHandle extends BaseViewHandle {
    ...
    public void ViewInit() {
        ...
        ActorGroup.add(Actor_Button1=new YzButton("界面测试一"),Actor_Button2=new YzButton("yoloV5训练集生成"),Actor_Button3=new YzButton("后台服务开启"),Actor_Button4=new YzButton("界面测试二"),Actor_Button5=new YzButton("STM32测试"),Actor_Button6=new YzButton("STM32数据生成")).find(YzButton.class).to(Actor_Menu).each(gdxQuery -> gdxQuery.cell().pad(5).right());
...
//                super.clicked(event, x, y);
        ...
        Actor_Button6.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y) {
                instance.remove();
                Views.addView(STM32DataCreateView.class);
                super.clicked(event, x, y);
            }
        });
    }
